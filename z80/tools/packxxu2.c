...
"  -p PAGES     set page count\n"
"\n"
"Patched by AHelper2 -- Allows signing with rabbitsign\n";

FILE *infile, *outfile;
int v_major=1, v_minor=0, calc=0x73, certid=4, hardware=0xff, pages=0x01;
...
int main(int argc, char** argv)
{
  ...
  unsigned char hdr_data[] = { 
    ...
    0x80,0xa1, 0x00,
// fix
    // NOTE: Added to allow signing with rabbit sign, from Build8XU
    0x80,0x81, 0x00,
    // Size doesn't matter here either
    0x80,0x7f, 0x00,0x00,0x00,0x00};
// fix
  int hdr_size = 6+3+3+3+3+3+6;
