...
;------------------------------------------------------------
;	CMakeCCompilerId.c:776: int main(int argc, char* argv[])
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	...
	mov	r6,dpl
	mov	r7,dph
;	CMakeCCompilerId.c:780: require += info_compiler[argc];
	mov	a,r6
	...
	mov	r3,a
	mov	r5,#0x00
;	CMakeCCompilerId.c:781: require += info_platform[argc];
	mov	a,r6
	...
	addc	a,r5
	mov	r4,a
;	CMakeCCompilerId.c:782: require += info_arch[argc];
	mov	a,r6
	add	a,_info_arch
	mov	r2,a
	mov	a,r7
	...
	addc	a,r4
	mov	r5,a
;	CMakeCCompilerId.c:784: require += info_version[argc];
	mov	a,r6
	add	a,#_info_version
	mov	dpl,a
	mov	a,r7
	...
	addc	a,r5
	mov	r3,a
;	CMakeCCompilerId.c:798: require += info_language_standard_default[argc];
	mov	a,r6
	...
	addc	a,r3
	mov	r3,a
;	CMakeCCompilerId.c:799: require += info_language_extensions_default[argc];
	mov	a,r6
	...
	addc	a,r3
	mov	dph,a
;	CMakeCCompilerId.c:801: return require;
;	CMakeCCompilerId.c:802: }
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
_info_version:
